...
// Fonction play
function playVideo() {
  play.parentNode.parentNode.title = "Pause (k)"
...
// Fonction pause
function pauseVideo() {
  play.parentNode.parentNode.title = "Lire (k)"
...
qualities.forEach(event => {
  ...
  if (qualitie_element.getAttribute('data-quality') === mainVideo.getAttribute('sizes')) {
