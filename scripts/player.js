...
<svg  class="webicon" style="height: 90px;"  viewBox="0 0 512 512">
    <path fill="#0053cf" d="M256 48C141.31 48 48 141.31 48 256s93.31 208 208 208 208-93.31 208-208S370.69 48 256 48zm74.77 217.3l-114.45 69.14a10.78 10.78 0 01-16.32-9.31V186.87a10.78 10.78 0 0116.32-9.31l114.45 69.14a10.89 10.89 0 010 18.6z"></path>
</svg>
...
<div class="controls">
    ...
    <div class="controls-list">
        <div class="controls-left">
            <button title="<< - 10s" class="skip-back icon actions">
            ...
            <button title="Lire (k)" class="icon actions">
            ...
            <button title="+ 10s >>" class="skip-fore icon actions">
            <svg viewBox="0 0 48 48">
            ...
            <div class="volume-container">
                <button class="volume icon actions" title="Couper ou activer le son (m)">
        ...
        <div class="controls-right">
            ...
            <button title="Sous-titres(c)" class="icon closed-caption actions">
            ...
            <button title="Lecteur réduit(i)" class="picture-in-picture icon actions">
            ...
            <button title="Plein écran (f)" class="toggleFullscreen icon actions">
