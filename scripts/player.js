...
<img src="./assets/ico.png" alt="webicon" class="webicon">
...
<div class="controls">
    ...
    <div class="controls-list">
        <div class="controls-left">
            <button title="<< - 10s" class="skip-back actions">
            ...
            <button title="+ 10s >>" class="skip-fore actions">
            <svg viewBox="0 0 48 48">
            ...
            <div class="volume-container">
                <button class="volume actions" title="Couper ou activer le son (m)">
        ...
        <div class="controls-right">
            ...
            <button title="Paramètres" class="settingsBtn actions">
                <i>
                <svg viewBox="0 0 48 48">
            ...
            <button title="Lecteur réduit(i)" class="picture-in-picture actions">
            ...
            <button title="Plein écran (f)" class="toggleFullscreen actions">
...
<div class="wrapper">
  ...
  <div class="drop" id="quality-drop">
    ...
    <li data-quality="" class="active">
      <div class="icon check"></div>
        Auto (${document.getElementById('main-video').getAttribute('sizes')}p)
      <p></p>
    </li>
  </ul>
  </div>
